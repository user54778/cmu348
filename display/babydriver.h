...
// NOTE: reset is AI-generated based on SSD1306 data sheet
...
#define SSD1306_SET_LOWER_COLUMN 0x00  // (0x00-0x0F)
#define SSD1306_SET_HIGHER_COLUMN 0x10 // (0x10-0x1F)
#define SSD1306_MEMORY_ADDR_MODE 0x20
#define SSD1306_SET_COLUMN_ADDR 0x21     // Triple byte command
#define SSD1306_SET_PAGE_ADDR 0x22       // Triple byte command
#define SSD1306_SET_PAGE_START_ADDR 0xB0 // (0xB0-0xB7)

// Hardware Configuration Commands
#define SSD1306_SET_START_LINE 0x40 // (0x40-0x7F)
...
#define SSD1306_COM_SCAN_DIR_REMAP 0xC8
#define SSD1306_SET_DISPLAY_OFFSET 0xD3 // Double byte command
#define SSD1306_SET_COM_PINS 0xDA       // Double byte command

// Timing & Driving Scheme Commands
#define SSD1306_SET_DISPLAY_CLOCK 0xD5    // Double byte command
#define SSD1306_SET_PRECHARGE_PERIOD 0xD9 // Double byte command
#define SSD1306_SET_VCOMH_DESELECT 0xDB   // Double byte command
#define SSD1306_NOP 0xE3

// Charge Pump Commands
#define SSD1306_CHARGE_PUMP_SETTING 0x8D // Double byte command
