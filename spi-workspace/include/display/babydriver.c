...
// NOTE: If len > size pointed to by ptr, bhvr is undefined
...
void bd_clear() {
  // NOTE: not checking return value
  oled_memset(BD_FRAMEBUFFER, 0x00, BD_FB_SIZE);
  bd_render_framebuffer();
}

void bd_init(void) {
  // AI-generated based on CN init function using custom
  // #defines.
